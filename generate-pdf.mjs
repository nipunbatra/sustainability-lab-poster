...
const htmlPath = path.resolve(__dirname, 'sustainability-lab-join-us-poster-light.html');
const pdfPath = path.resolve(__dirname, 'sustainability-lab-join-us-poster-light.pdf');
